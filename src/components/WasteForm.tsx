      ...
      <div className="space-y-4 bg-rose-50/20 border border-rose-100/50 p-4 rounded-2xl">
        ...
        {wasteWeight > 10 && (
          <div className="p-3 bg-amber-50 rounded-xl border border-amber-200/50 flex gap-2 text-xs text-amber-800 font-medium leading-relaxed">
            ...
            <span>
              <strong>Cảnh báo phế phẩm cao:</strong> Khối lượng phế phẩm vượt quá 10kg có thể ảnh hưởng lớn đến hiệu suất định mức của phân xưởng HCM. Hãy ghi rõ nguyên nhân lỗi ở khung ghi chú bên dưới!
            </span>
          </div>
        )}
      </div>
