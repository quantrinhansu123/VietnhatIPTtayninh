    ...
    * { box-sizing: border-box; }
    ...
    <main class="sheet">
      <header class="header">
        ...
        <div class="company">Công ty cổ phần vật liệu cách nhiệt Việt Nhật<br>Chi nhánh HCM</div>
      </header>
      ...
      <div class="sign-date">HCM, ngày ...... tháng ...... năm ........</div>
      <div class="sign-grid">
        <div class="sign-box">
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    <main class="sheet">
      <header class="header">
        <img class="logo" src="${escapePrintHtml(vietNhatLogoUrl)}" alt="Việt Nhật">
        <div class="company">Công ty cổ phần vật liệu cách nhiệt Việt Nhật<br>Đ/c: Chi nhánh HCM</div>
      </header>
